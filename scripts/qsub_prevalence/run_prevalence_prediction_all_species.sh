...
#qsub -N 'Eubacterium_rectale_56927' /u/home/w/wrshoema/project-ngarud/snv_prevalence/scripts/qsub_prevalence/qsub_predicted_occupancy.sh 'Eubacterium_rectale_56927'
