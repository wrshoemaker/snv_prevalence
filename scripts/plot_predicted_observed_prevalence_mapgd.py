...
def make_plot(variant_type, slm=True):
    ...
    for column_idx, column in enumerate(nested_species_list):
        ...
        for row_idx, row in enumerate(column):
            ...
            sorted_plot_data = prevalence_utils.plot_color_by_pt_dens(observed_prevalence_no_zeros, predicted_prevalence_no_zeros, radius=prevalence_utils.color_radius, loglog=1)
