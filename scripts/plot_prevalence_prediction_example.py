...
ax_prevalence_eco.set_xlabel('Observed SNV prevalence', fontsize=12)
ax_prevalence_eco.set_ylabel('Predicted SNV prevalence', fontsize=12)
...
ax_prevalence_evo.set_xlabel('Observed SNV prevalence', fontsize=12)
ax_prevalence_evo.set_ylabel('Predicted SNV prevalence', fontsize=12)
...
ax_abundance_prevalence_eco.set_xlabel('Mean SNV frequency, ' + r'$\bar{f}$', fontsize=12)
ax_abundance_prevalence_eco.set_ylabel('SNV prevalence', fontsize=12)
...
ax_abundance_prevalence_evo.set_xlabel('Max. SNV frequency, ' + r'$f_{max}$', fontsize=12)
ax_abundance_prevalence_evo.set_ylabel('SNV prevalence', fontsize=12)
...
ax_error.set_ylabel('Fraction of SNVs ' + r'$\geq \epsilon$', fontsize=12)
