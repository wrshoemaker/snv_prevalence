#!/bin/bash
#$ -N kegg_pi
#$ -e /u/project/ngarud/wrshoema/negative_selection_microbiome/scripts/kegg_pi_error
#$ -o /u/project/ngarud/wrshoema/negative_selection_microbiome/scripts/kegg_pi_output
#$ -l h_data=24G
#$ -l time=36:00:00
#$ -l highp
#$ -m bea
...
python /u/project/ngarud/wrshoema/negative_selection_microbiome/scripts/loop_over_species_wrapper.py all python /u/project/ngarud/wrshoema/negative_selection_microbiome/scripts/calculate_per_gene_dnds.py
