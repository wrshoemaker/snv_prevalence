...
OUTDIR=/u/home/w/wrshoema/project-ngarud/HMP_MAPGD/midas_output/${acc}
...
bam=/u/home/w/wrshoema/project-ngarud/HMP_MAPGD/midas_output/${acc}/snps/temp/genomes.bam
# index bam
samtools index ${bam}
...
while read species; do
  echo "$species"
  species_genome_bed=/u/home/w/wrshoema/project-ngarud/HMP_MAPGD/rep_genomes/${species}/genome.bed
  species_dir=/u/home/w/wrshoema/project-ngarud/HMP_MAPGD/midas_output_bam/${species}/
  bowtie2_build=/u/home/w/wrshoema/project-ngarud/HMP_MAPGD/rep_genomes/${species}/${species}/
