#!/bin/bash
#$ -N Acidaminococcus_intestini_54097
...
species=Acidaminococcus_intestini_54097
#species=$1
...
done </u/project/ngarud/wrshoema/negative_selection_microbiome/scripts/qsub_HMP_MAPGD/samples_species/HMP1-2_samples_final_${species}_old.txt
