...
def make_plot(clade_type, pi_type, variant_type='4D'):
    ...
    for column_idx, column in enumerate(nested_species_list):
        ...
        for row_idx, row in enumerate(column):
            ...
            #predicted_prevalence_all_no_zeros = predicted_prevalence_all[(observed_prevalence_all>0) & (predicted_prevalence_all>0)]
            #observed_prevalence_all_no_zeros = observed_prevalence_all[(observed_prevalence_all>0) & (predicted_prevalence_all>0)]
            #f_max_all_no_zeros = f_max_all[(observed_prevalence_all>0) & (predicted_prevalence_all>0)]
