...
intermediate_filename_template = '%s%s_f0_%f.txt.gz'
...
def load_ld_map(species_name, f0):
    ...
    intermediate_filename = intermediate_filename_template % (ld_directory, species_name, f0)
...
def calculate_ld_dict(good_species_list, subject_sample_map, f0, bin_width_exponent=0.1, variant_types = ['4D','1D'], debug=False):
    ...
    for species_name in good_species_list:
        ...
        # Load precomputed LD
        ld_map = load_ld_map(species_name, f0)
        ld_dict = {}
...
if __name__=='__main__':
    ...
    for species_name in good_species_list:
        ...
        for f0 in f0_range:
            ...
            ld_map = load_ld_map(good_species_list[0], f0_range[0])
            sys.stderr.write("Done!\n")
