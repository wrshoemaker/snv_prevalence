...
def load_ld_map(species_name):
    ...
    ld_directory = '%scoprevalence/' % (parse_midas_data.data_directory)
...
if __name__=='__main__':
    ...
    for species_name in good_species_list:
        ...
        while final_line_number >= 0:
            ...
            sys.stderr.write("Calculating coprevalence...\n")
            for clade_type in clade_types:
                ...
                for variant_type in variant_types:
                    ...
                    for gene_name in allele_counts_map.keys():
                        ...
                        #sigma_k_numerator, sigma_k_denominator = diversity_utils.calculate_unbiased_sigma_k_prevalence(allele_counts, allele_counts, f0=0, k=2)

                        rsquared_numerators, rsquared_denominators = diversity_utils.calculate_unbiased_sigmasquared_prevalence(allele_counts, allele_counts)
                        ...
                        for neighbor_distance_idx in xrange(0,len(neighbor_distances)):
                            ...
                            for neighboring_gene_name in neighboring_genes:
                                ...
                                chunk_rsquared_numerators, chunk_rsquared_denominators = diversity_utils.calculate_unbiased_sigmasquared_prevalence(allele_counts, neighboring_allele_counts)
                        ...
                        for control_idx in xrange(0,10):
                            ...
                            control_gene_rsquared_numerators, control_gene_rsquared_denominators = diversity_utils.calculate_unbiased_sigmasquared_prevalence(allele_counts, control_allele_counts)
