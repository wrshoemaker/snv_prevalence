...
if os.geteuid() == 501:
    data_directory = os.path.expanduser("~/GitHub/snv_prevalence/data/")
    analysis_directory = os.path.expanduser("~/GitHub/snv_prevalence/analysis/")
    scripts_directory = os.path.expanduser("~/GitHub/snv_prevalence/scripts/")

    midas_directory = os.path.expanduser("~/GitHub/snv_prevalence/data/midas_db_v1.2/")
    patric_directory = os.path.expanduser("~/GitHub/snv_prevalence/data/patric_db/")
    metadata_directory = os.path.expanduser("~/GitHub/snv_prevalence/scripts/metadata/")



else:

    data_directory = os.path.expanduser("/u/project/ngarud/wrshoema/snv_prevalence/data/")
    analysis_directory = os.path.expanduser("/u/project/ngarud/wrshoema/snv_prevalence/analysis/")
    scripts_directory = os.path.expanduser("/u/project/ngarud/wrshoema/snv_prevalence/scripts/")

    midas_directory = os.path.expanduser("/u/project/ngarud/wrshoema/snv_prevalence/data/midas_db_v1.2/")
    patric_directory = os.path.expanduser("/u/project/ngarud/wrshoema/snv_prevalence/data/patric_db/")
    metadata_directory = os.path.expanduser("/u/project/ngarud/wrshoema/snv_prevalence/scripts/metadata/")
